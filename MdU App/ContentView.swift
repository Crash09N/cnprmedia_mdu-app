    ...
    var body: some View {
        NavigationView {
            ZStack {
                ...
                FloatingMenuBar(showSchülerausweis: $showSchülerausweis, showTimetable: $showTimetable)
            }
            ...
            .fullScreenCover(isPresented: $showTimetable) {
                TimetableView()
            }
        }
    }
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                ...
                Spacer()
                MenuButton(icon: "calendar", action: {
                    showTimetable = true
                })
                Spacer()
